...
export default function AdminReport() {
  ...
  return (
    ...
    <div className="ps-16 pe-8 pb-2 pt-8 flex gap-[700px]">
        <p className="text-gray-800 font-semibold text-lg">There is <span className="text-blue-700 font-bold">{CardsData.length}</span> events found</p>
        <p className="text-gray-800 font-semibold text-lg">Sort by:<span className="text-md text-blue-700 font-bold">Date</span></p>
    </div>
    ...
    {CardsData.map((card)=>(
            <div className=" bg-gray-200 flex justify-center items-center p-4 rounded-md border-2 w-full border-gray-300" key={card.id}>
                ...
                <div className=" basis-1/2 ps-8 pe-8 w-fit">
                    ...
                    <div className="pb-4"> 
                        <p className="text-lg font-medium text-gray-600">Report Reason : {card.ReportReason}</p>
                        <p className="text-lg font-medium text-gray-600">Send By :{card.user}</p>
                ...
                <div className=" basis-1/4 flex flex-col  items-center gap-2">
                    ...
                    <button className="border-none p-1 text-lg bg-slate-400 rounded-lg text-white w-32  hover:scale-[1.05] transition duration-500">Send Warning</button>
